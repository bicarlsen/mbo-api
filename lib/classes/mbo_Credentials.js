...
function Credentials( credentials, siteIds, type ) {
	this.credentials = _createCredentials( credentials );
	this.siteIds = [];
 ...
 *
 * @return {object} Returns an object with keys [ 'sourceCredentials', 'apiKey' ], 
 ...
 */
 Credentials.prototype._createCredentials = function( credentials ) {
	...
	if( if( Object.values( creds ).every( c => c === undefined ) ) { ) {
