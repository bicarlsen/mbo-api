 ...
 */
function mbo_ClassService( username, password ) {
	mboService.call( this, 'ClassService', username, password );
}
 ...
 * @return {Promise}         An A+ romise passed an array of client IDs who attended the class.
 */
